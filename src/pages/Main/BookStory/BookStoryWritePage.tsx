  ...
  return (
    <div>
      <div className="max-w-5xl mx-auto p-8 space-y-8 font-sans text-gray-900">
        <div className="relative flex items-start gap-6 p-6 border border-[#EAE5E2] rounded-xl bg-white">
        ...
        <div className="p-6 border border-[#EAE5E2] rounded-xl bg-white min-h-[22rem] flex flex-col ">
          <input
            type="text"
