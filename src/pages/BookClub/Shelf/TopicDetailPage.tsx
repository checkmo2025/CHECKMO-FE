        ...
        <div onClick={() => navigate(-1)} className="flex items-center h-[38px] gap-[3px] cursor-pointer mb-[30px]">
          ...
          <div className=" flex flex-col overflow-y-auto h-[calc(100vh-140px)] overscroll-none" style={{ msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
            ...
            <div className=" py-2 flex shadow rounded-2xl border-2 border-[var(--sub-color-2-brown,#EAE5E2)] mb-3   transition-transform duration-300 hover:shadow-md">
              <div className="flex-shrink-0 items-center w-[222px] h-[48px] ml-[12px] flex gap-[19px] mr-[15px] cursor-pointer" onClick={() => {navigate(`/info/others/${Mynickname}`)}}>
            ...
            <div className="flex flex-col gap-3">
              {TopicList.map((Topic: TopicItem) => (
                <div key={Topic.topicId} className="flex py-2 flex shadow rounded-2xl border-2 border-[var(--sub-color-2-brown,#EAE5E2)] hover:shadow-md">
                    <div className= "flex-shrink-0 items-center w-[222px] h-[48px] ml-[12px] flex gap-[19px] mr-[15px] cursor-pointer" onClick={() => {
