  ...
  return (
    <div className=" flex flex-col flex-1">
      ...
      <div className="mt-9 flex items-center h-[53px] py-[10px] px-[17px] rounded-2xl bg-[var(--Color-4,#F4F2F1)]">
        ...
        />
        <input type="text" placeholder="검색하기 (도서명, 작가, 출판사)"  className=" text-[18px] mx-[14px] font-pretendard font-medium bg-transparent outline-none flex-1 leading-[135%] tracking-[-0.1%] text-[var(--Gray-1,#2C2C2C)] ]"
        />
      </div>
...
>
        {books.map((book, idx) => (
  <div key={idx} className="flex border-2 border-[var(--sub-color-2-brown,#EAE5E2)] rounded-2xl bg-[var(--White,#FFF)] shadow-sm">
