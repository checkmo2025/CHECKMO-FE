...
export default function MeetingNoticeContent({ data }: MeetingNoticeContentProps): React.ReactElement {
  ...
  return (
    <div>
      {/* 상단 영역 */}
      <div className="w-full max-w-[1150px] flex flex-col lg:flex-row gap-[16px] lg:gap-[32px] mb-[12px]">
        {/* 왼쪽: 책 이미지 */}
        ...
        <div className="flex-1 relative min-w-0">
          {/* 책 제목 */}
          <div className="flex items-center mb-[6px] w-full">
            <h2 className="font-semibold text-[18px] md:text-[20px] text-[#000000] break-words w-full">
              {data.bookInfo?.title}
            </h2>
          </div>
      ...
      <div className="flex flex-col mb-[20px]">
        ...
        <div className="bg-[#F4F2F1] w-full max-w-[1150px] h-auto min-h-[53px] mt-[12px] lg:mt-[19px] rounded-[16px] flex items-center gap-[12px] py-[12px]">
      ...
      {/* 하단: 상세 설명 */}
      <div className="w-full max-w-[1150px] h-auto p-[16px] lg:p-[20px] border-[2px] border-[#EAE5E2] rounded-[16px] mb-[36px] mr-[12px] md:mr-[18px]">
